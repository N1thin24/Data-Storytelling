...
with st.container():
    ...
    with col2:              
        ...
        st.markdown("<h4 style='text-align: center;'>Neighbourhood Lowest Price</h4>", unsafe_allow_html=True)
...
with col3:
    ...
    fig = px.histogram(data_filtered, x="price", color='neighbourhood_group', nbins=45)
    fig.update_xaxes(title_text='Price', tickprefix='$')  # Add dollar sign
